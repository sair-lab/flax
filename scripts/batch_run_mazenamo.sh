...
run_experiment() {
    ...
    ln -s "${BASE_DIR}/pddl_files/problems/mazenamo_problems/pddl_${PROBLEM_SIZE}x${PROBLEM_SIZE}_${DIFFICULTY}" "${BASE_DIR}/pddlgym/pddl/mazenamo_test"
    ...
    if [ "$PLANNER_TYPE" = "pure" ]; then
        cmd_str="python -u src/main.py --domain_name ${DOMAIN_NAME} \
            ...
            --num_test_problems ${NUM_TEST_PROBLEMS} --planner_type ${PLANNER_TYPE} --test_timeout ${TIMEOUT}"
    else
        cmd_str="python -u src/main.py --domain_name ${DOMAIN_NAME} \
            ...
            --train_timeout 120 --test_timeout ${TIMEOUT} --num_epochs 301 \
            --cmpl_rules config/mazenamo_complementary_rules.json --relx_rules config/mazenamo_relaxation_rules_1.json"
    fi
...
experiments=(
    ...
    "10 easy 5 300 relx"
    "10 easy 5 300 flax"
    "10 medium 5 200 pure"
    "10 medium 5 200 ploi"
    "10 medium 5 200 cmpl"
    "10 medium 5 200 relx"
    "10 medium 5 200 flax"
    "10 hard 5 100 pure"
    "10 hard 5 100 ploi"
    "10 hard 5 100 cmpl"
    "10 hard 5 100 relx"
    ...
    "12 easy 20 300 relx"
    "12 easy 20 300 flax"
    "12 medium 20 200 pure"
    "12 medium 20 200 ploi"
    "12 medium 20 200 cmpl"
    "12 medium 20 200 relx"
    ...
    "15 easy 40 300 relx"
    "15 easy 40 300 flax"
    "15 medium 40 200 pure"
    "15 medium 40 200 ploi"
    "15 medium 40 200 cmpl"
    "15 medium 40 200 relx"
    "15 medium 40 200 flax"
    "15 hard 40 100 pure"
    "15 hard 40 100 ploi"
    "15 hard 40 100 cmpl"
    "15 hard 40 100 relx"
