...
if __name__ == "__main__":
    ...
    # Load USD stage and extract 2D center points
    # open_stage(f"{assets_root_path}/{WAREHOUSE_SIZE}x{WAREHOUSE_SIZE}_namo_0.usd")
    # open_stage(f"{assets_root_path}/{WAREHOUSE_SIZE}x{WAREHOUSE_SIZE}_namo_example.usd")
    ...
    frame_count = 0
    video_0_path = f"{os.getcwd()}/assets/persp_camera_{problem_size}x{problem_size}_{problem_mode}_{problem_idx}.mp4"
    # video_0_path = f"{os.getcwd()}/assets/persp_camera_example.mp4"
    writer_0 = imageio.get_writer(video_0_path, fps=120, format='ffmpeg')
    video_1_path = f"{os.getcwd()}/assets/forklift_camera_{problem_size}x{problem_size}_{problem_mode}_{problem_idx}.mp4"
    # video_1_path = f"{os.getcwd()}/assets/forklift_camera_example.mp4"
